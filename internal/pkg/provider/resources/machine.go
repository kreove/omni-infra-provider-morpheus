...
// Package resources contains resources stored in the Morpheus provider state.
package resources
...
import (
	...
	"github.com/kreove/omni-infra-provider-morpheus/api/specs"
	providermeta "github.com/kreove/omni-infra-provider-morpheus/internal/pkg/provider/meta"
)
...
// Machine describes Morpheus machine provisioning state.
